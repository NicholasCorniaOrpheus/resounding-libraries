...
def sftp_download_tiff_dir_compress(sftp, d, tiff_dir, local_dir):
    ...
    if d in os.listdir(local_dir):
        ...
        # compression
        print(f"TIFF files to be compressed for {d}")
...
for d in sftp.listdir(tiff_dir):
    sftp_download_tiff_dir_compress(sftp, d, tiff_dir, local_dir)
